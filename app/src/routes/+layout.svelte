...
{#if $toast}
	<div
		...
		class="fixed bottom-2 left-[50%] z-3 flex min-h-[75px] w-[90%] translate-x-[-50%] flex-col gap-y-2 rounded-lg bg-stone-300 p-2 font-['General_Sans',sans-serif] outline outline-2 outline-red-600"
	>
